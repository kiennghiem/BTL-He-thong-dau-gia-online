...
public class Art extends Item {
    ...
    public Art(String id, String itemName, String description, BigDecimal startingPrice, String specialAttribute, Seller owner) {
        super(id, ItemType.ART, itemName, description, startingPrice, specialAttribute, owner);
    }
